...
Result_t I2C::Init(I2C_Config_t *conf){
	...
	/* ***********************ADDRESS 7 OR 10BIT********************** */
	if(_conf -> i2c_addressmode == I2C_ADDRESS_10BIT)     _i2c -> OAR1 |= (I2C_OAR1_ADDMODE | 0x00004000U) | _conf -> i2c_slavemode_address;
	else if(_conf -> i2c_addressmode == I2C_ADDRESS_7BIT) _i2c -> OAR1 |= 0x00004000U | _conf -> i2c_slavemode_address;
...
Result_t I2C::SendStop(void){
	...
	return {OKE, __LINE__, 0, 0, __FUNCTION__, __FILE__};
}
